...
assessment, assessment_activity, evaluation_criteria, explanatory_illustrative_method,
...
Создай профессиональный план урока. По таксономии Блума, с конкретными измеримыми результатами и критериями оценивания.
...
def create_lecture(subject, topic, language, specialty, pck, lesson_type, config):
    system = """
Ты методист колледжа Казахстана. Пиши академичный и профессиональный материал для преподавателя, по таксономии Блума, с конкретными измеримыми результатами и критериями оценивания.
