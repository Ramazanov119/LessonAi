...
2. Формирование новых знаний и способов деятельности (Понимание)
...
Для каждого этапа подробно опиши действия преподавателя и студентов.
